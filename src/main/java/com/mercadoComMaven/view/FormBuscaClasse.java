...
public class FormBuscaClasse extends javax.swing.JDialog {

    public FormBuscaClasse(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (tabelaBusca.getColumnModel().getColumnCount() > 0) {
            ...
            tabelaBusca.getColumnModel().getColumn(1).setMinWidth(500);
            tabelaBusca.getColumnModel().getColumn(1).setMaxWidth(500);
        }
        ...
        Carregar.setIcon(new javax.swing.ImageIcon("C:\\Users\\aluno\\Desktop\\jp\\mercado-retaguarda\\src\\test\\java\\images\\Find.png")); // NOI18N
