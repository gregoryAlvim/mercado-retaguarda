...
public class FormBuscaBairro extends javax.swing.JDialog {

    public FormBuscaBairro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (tabelaBusca.getColumnModel().getColumnCount() > 0) {
            tabelaBusca.getColumnModel().getColumn(0).setMaxWidth(40);
        }
