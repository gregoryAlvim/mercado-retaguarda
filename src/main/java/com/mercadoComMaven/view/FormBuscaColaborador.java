...
public class FormBuscaColaborador extends javax.swing.JDialog {

    public FormBuscaColaborador(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (tabelaBusca.getColumnModel().getColumnCount() > 0) {
            tabelaBusca.getColumnModel().getColumn(0).setMinWidth(35);
            tabelaBusca.getColumnModel().getColumn(0).setMaxWidth(35);
            tabelaBusca.getColumnModel().getColumn(1).setMinWidth(300);
            tabelaBusca.getColumnModel().getColumn(1).setMaxWidth(300);
            tabelaBusca.getColumnModel().getColumn(2).setMinWidth(200);
            tabelaBusca.getColumnModel().getColumn(2).setMaxWidth(200);
            tabelaBusca.getColumnModel().getColumn(3).setMinWidth(45);
            tabelaBusca.getColumnModel().getColumn(3).setMaxWidth(45);
        }
