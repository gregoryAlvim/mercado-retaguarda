...
public class FormBuscaCliente extends javax.swing.JDialog {

    public FormBuscaCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (tabelaBusca.getColumnModel().getColumnCount() > 0) {
            ...
            tabelaBusca.getColumnModel().getColumn(1).setMinWidth(200);
            tabelaBusca.getColumnModel().getColumn(1).setMaxWidth(200);
            tabelaBusca.getColumnModel().getColumn(2).setMinWidth(150);
            tabelaBusca.getColumnModel().getColumn(2).setMaxWidth(150);
            tabelaBusca.getColumnModel().getColumn(3).setMinWidth(80);
            tabelaBusca.getColumnModel().getColumn(3).setMaxWidth(80);
            tabelaBusca.getColumnModel().getColumn(4).setMinWidth(50);
            tabelaBusca.getColumnModel().getColumn(4).setMaxWidth(50);
        }
