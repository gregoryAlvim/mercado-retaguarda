...
public class FormBuscaProduto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tabelaBusca.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Descrição", "Valor Compra", "Valor Venda", "Status"
            }
        ) {
        ...
        if (tabelaBusca.getColumnModel().getColumnCount() > 0) {
            ...
            tabelaBusca.getColumnModel().getColumn(2).setMinWidth(80);
            tabelaBusca.getColumnModel().getColumn(2).setMaxWidth(80);
