...
public class FormBuscaFornecedor extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        if (tabelaBusca.getColumnModel().getColumnCount() > 0) {
            ...
            tabelaBusca.getColumnModel().getColumn(1).setMinWidth(150);
            tabelaBusca.getColumnModel().getColumn(1).setMaxWidth(150);
            tabelaBusca.getColumnModel().getColumn(2).setMinWidth(150);
            tabelaBusca.getColumnModel().getColumn(2).setMaxWidth(150);
            tabelaBusca.getColumnModel().getColumn(3).setMinWidth(150);
            tabelaBusca.getColumnModel().getColumn(3).setMaxWidth(150);
        }
